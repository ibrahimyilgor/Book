  ...
  return (
    <ImageBackground source={require('../images/back1.jpg')} style={styles.image}>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity  onPress={() => navigation.navigate('Kitaplarim')} style={styles.appButtonContainer}>
          <Text style={styles.appButtonText}>{"Kitaplarım"}</Text>
        </TouchableOpacity>
        <TouchableOpacity  onPress={() => navigation.navigate('Istatistikler')} style={styles.appButtonContainer}>
          <Text style={styles.appButtonText}>{"İstatistikler"}</Text>
        </TouchableOpacity>
        <TouchableOpacity  onPress={() => navigation.navigate('Ayarlar')} style={styles.appButtonContainer}>
